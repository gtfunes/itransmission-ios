...
{	
	...
	CGRect bounds = CGRectMake(0, 0, self.width, numberSize.height);
    ...
    bounds.origin.y = (bounds.size.height / 2) - (numberSize.height / 2);
    bounds.origin.x = (bounds.size.width / 2) - (numberSize.width / 2);
